...
\textbf{Answer}: - In a Given data we have attributes
\emph{from\_station\_id} and \emph{to\_station\_id} so based on that we
can see the pattern of uses of bike where it extremely high more than
expected and where its quite below the expected uses.We can answer where
we need to adjust number of bike available in certain station based on
need.We can solved supply and demand problem with flexibility of changes
basaed on data - We can answer what age group more uses bikeshare system
in particular city after data analysis.
...
{\color{incolor}In [{\color{incolor}3}]:} \PY{k}{def} \PY{n+nf}{duration\PYZus{}in\PYZus{}mins}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{k}{elif} \PY{n}{city} \PY{o}{==}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Chicago}\PY{l+s+s2}{\PYZdq{}} \PY{o+ow}{or} \PY{n}{city} \PY{o}{==}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
...
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{def} \PY{n+nf}{time\PYZus{}of\PYZus{}trip}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                \PY{n}{tt}\PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{starttime}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s2}{/}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{Y }\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{H:}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{M:}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{S}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
            ...
            \PY{k}{elif} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                \PY{n}{tt}\PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Start date}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s2}{/}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{Y }\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{H:}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{M}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
            
            \PY{n}{month}\PY{o}{=}\PY{n}{tt}\PY{o}{.}\PY{n}{month}
            \PY{n}{hour}\PY{o}{=} \PY{n}{tt}\PY{o}{.}\PY{n}{hour}
            \PY{n}{day\PYZus{}of\PYZus{}week}\PY{o}{=}\PY{n}{tt}\PY{o}{.}\PY{n}{strftime}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{A}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}5}]:} \PY{k}{def} \PY{n+nf}{type\PYZus{}of\PYZus{}user}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{k}{elif} \PY{n}{city} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{NYC}\PY{l+s+s2}{\PYZdq{}} \PY{o+ow}{or} \PY{n}{city} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Chicago}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{out\PYZus{}file}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{w}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}out}\PY{p}{,} \PY{n+nb}{open}\PY{p}{(}\PY{n}{in\PYZus{}file}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                ...
                \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{trip\PYZus{}reader}\PY{p}{:}
                    ...
                    \PY{n}{dura} \PY{o}{=} \PY{n}{duration\PYZus{}in\PYZus{}mins}\PY{p}{(}\PY{n}{row}\PY{p}{,} \PY{n}{city}\PY{p}{)}
                    ...
                    \PY{n}{new\PYZus{}point}\PY{p}{[}\PY{n}{out\PYZus{}colnames}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{]}\PY{o}{=}\PY{n}{dura}
...
\textbf{Answer}: - City which has the highest number of trips is:NYC -
City which has the highest proportion of trips made by subscribers is:
Chicago - City which has the highest proportion of trips made by
short-term customers is:NYC

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{k}{def} \PY{n+nf}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
            \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                ...
                \PY{k}{return} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscribers}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{n}{n\PYZus{}subscribers}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customers}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{n}{n\PYZus{}customers}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Total}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{n}{n\PYZus{}total}\PY{p}{\PYZcb{}}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}9}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Modify this and the previous cell to answer Question 4a. Remember to run \PYZsh{}\PYZsh{}}
        ...
        \PY{n}{city\PYZus{}trip\PYZus{}record}\PY{o}{=}\PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
        
        \PY{k}{for} \PY{n}{data\PYZus{}file} \PY{o+ow}{in} \PY{n}{data\PYZus{}files}\PY{p}{:}
            \PY{n}{city} \PY{o}{=} \PY{n}{data\PYZus{}file}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}
            \PY{n}{city\PYZus{}trip\PYZus{}record}\PY{p}{[}\PY{n}{city}\PY{p}{]} \PY{o}{=} \PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}
        \PY{n+nb}{print}\PY{p}{(}\PY{n}{city\PYZus{}trip\PYZus{}record}\PY{p}{)}
        \PY{n}{highest\PYZus{}trip} \PY{o}{=} \PY{l+m+mi}{0}
        \PY{n}{highest\PYZus{}pro\PYZus{}subs} \PY{o}{=} \PY{l+m+mi}{0}
        \PY{n}{highest\PYZus{}pro\PYZus{}cust} \PY{o}{=} \PY{l+m+mi}{0}
        \PY{k}{for} \PY{n}{k}\PY{p}{,}\PY{n}{v} \PY{o+ow}{in} \PY{n}{city\PYZus{}trip\PYZus{}record}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}
            \PY{n}{pro\PYZus{}subs} \PY{o}{=} \PY{n}{v}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscribers}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{/}\PY{n}{v}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Total}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
            \PY{n}{pro\PYZus{}cust} \PY{o}{=} \PY{n}{v}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customers}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{/}\PY{n}{v}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Total}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
            \PY{k}{if} \PY{n}{pro\PYZus{}cust} \PY{o}{\PYZgt{}}\PY{o}{=} \PY{n}{highest\PYZus{}pro\PYZus{}cust}\PY{p}{:}
                \PY{n}{highest\PYZus{}pro\PYZus{}cust} \PY{o}{=} \PY{n}{pro\PYZus{}cust}
                \PY{n}{highest\PYZus{}pro\PYZus{}cust\PYZus{}city} \PY{o}{=} \PY{n}{k}
            \PY{k}{if} \PY{n}{pro\PYZus{}subs} \PY{o}{\PYZgt{}}\PY{o}{=} \PY{n}{highest\PYZus{}pro\PYZus{}subs}\PY{p}{:}
                \PY{n}{highest\PYZus{}pro\PYZus{}subs} \PY{o}{=} \PY{n}{pro\PYZus{}subs}
                \PY{n}{highest\PYZus{}pro\PYZus{}subs\PYZus{}city} \PY{o}{=} \PY{n}{k}
            \PY{k}{if} \PY{n}{highest\PYZus{}trip} \PY{o}{\PYZlt{}}\PY{o}{=} \PY{n}{v}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Total}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{:}
                \PY{n}{highest\PYZus{}trip} \PY{o}{=} \PY{n}{v}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Total}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
                \PY{n}{highest\PYZus{}trip\PYZus{}city} \PY{o}{=} \PY{n}{k}
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{city which has the highest number of trips is:}\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n}{highest\PYZus{}pro\PYZus{}subs\PYZus{}city}\PY{p}{)}
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{city which has the highest proportion of trips made by subscribers is: }\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}\PY{n}{highest\PYZus{}pro\PYZus{}cust\PYZus{}city}\PY{p}{)}
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{city which has the highest proportion of trips made by short\PYZhy{}term customers is:}\PY{l+s+s2}{\PYZdq{}}\PY{o}{+}\PY{n}{highest\PYZus{}trip\PYZus{}city}\PY{p}{)}        
\end{Verbatim}
...
\textbf{Answer}: Replace this text with your reponse!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 4b.                 \PYZsh{}\PYZsh{}}
        ...
        \PY{k}{def} \PY{n+nf}{duration\PYZus{}of\PYZus{}trip}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
            \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                \PY{c+c1}{\PYZsh{} set up csv reader object}
                \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                \PY{n}{av\PYZus{}trip\PYZus{}length} \PY{o}{=} \PY{l+m+mi}{0}
                \PY{n}{long\PYZus{}trip\PYZus{}pro} \PY{o}{=} \PY{l+m+mi}{0}
                \PY{n}{row\PYZus{}count}\PY{o}{=}\PY{l+m+mi}{0}
                \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                    \PY{n}{row\PYZus{}count} \PY{o}{=} \PY{n}{row\PYZus{}count} \PY{o}{+} \PY{l+m+mi}{1}
                    \PY{n}{av\PYZus{}trip\PYZus{}length} \PY{o}{=} \PY{n}{av\PYZus{}trip\PYZus{}length} \PY{o}{+} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                    \PY{k}{if} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)} \PY{o}{\PYZgt{}} \PY{l+m+mf}{30.0}\PY{p}{:}
                        \PY{n}{long\PYZus{}trip\PYZus{}pro} \PY{o}{=} \PY{n}{long\PYZus{}trip\PYZus{}pro} \PY{o}{+} \PY{l+m+mi}{1}
                \PY{n}{av\PYZus{}trip\PYZus{}length} \PY{o}{=} \PY{n}{av\PYZus{}trip\PYZus{}length}\PY{o}{/}\PY{n}{row\PYZus{}count}
                \PY{n}{long\PYZus{}trip\PYZus{}pro} \PY{o}{=} \PY{n}{long\PYZus{}trip\PYZus{}pro}\PY{o}{/}\PY{n}{row\PYZus{}count}
                \PY{k}{return} \PY{p}{\PYZob{}}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{average\PYZus{}trip\PYZus{}length}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{av\PYZus{}trip\PYZus{}length}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{long\PYZus{}trip}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{long\PYZus{}trip\PYZus{}pro}\PY{p}{\PYZcb{}}
            
        \PY{n}{trip\PYZus{}record} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
        \PY{n}{type\PYZus{}trip\PYZus{}record} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
        \PY{k}{for} \PY{n}{data\PYZus{}file} \PY{o+ow}{in} \PY{n}{data\PYZus{}files}\PY{p}{:}
            \PY{n}{city} \PY{o}{=} \PY{n}{data\PYZus{}file}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}
            \PY{n}{trip\PYZus{}record}\PY{p}{[}\PY{n}{city}\PY{p}{]} \PY{o}{=} \PY{n}{duration\PYZus{}of\PYZus{}trip}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}
            
        \PY{n+nb}{print}\PY{p}{(}\PY{n}{trip\PYZus{}record}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
\{'NYC': \{'average\_trip\_length': 15.81259299802294, 'long\_trip': 0.07302437156337835\}, 'Chicago': \{'average\_trip\_length': 16.563629368787335, 'long\_trip': 0.08332062497400562\}, 'Washington': \{'average\_trip\_length': 18.93287355913721, 'long\_trip': 0.10838886711093688\}\}
...
\textbf{Answer}: Based on NewYork City bikeshare data,average Customers
take significantly long trip(about 2.46 times) compared to subscribers.
- \textbf{So Customers takes longer rides.}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 4c. If you have    \PYZsh{}\PYZsh{}}
        ...
        \PY{k}{def} \PY{n+nf}{type\PYZus{}duration\PYZus{}of\PYZus{}trip}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
            \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                \PY{c+c1}{\PYZsh{} set up csv reader object}
                \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                \PY{n}{av\PYZus{}subs}\PY{o}{=}\PY{l+m+mi}{0}
                \PY{n}{total\PYZus{}row\PYZus{}sub} \PY{o}{=}\PY{l+m+mi}{0}
                \PY{n}{total\PYZus{}row\PYZus{}cus} \PY{o}{=} \PY{l+m+mi}{0}
                \PY{n}{av\PYZus{}cust}\PY{o}{=}\PY{l+m+mi}{0}
                \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
        
                    \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                        \PY{n}{total\PYZus{}row\PYZus{}sub} \PY{o}{=} \PY{n}{total\PYZus{}row\PYZus{}sub} \PY{o}{+}\PY{l+m+mi}{1}
                        \PY{n}{av\PYZus{}subs} \PY{o}{=} \PY{n}{av\PYZus{}subs}\PY{o}{+} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{duration}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}
        
                    \PY{k}{else}\PY{p}{:}
                        \PY{n}{total\PYZus{}row\PYZus{}cus} \PY{o}{=} \PY{n}{total\PYZus{}row\PYZus{}cus} \PY{o}{+}\PY{l+m+mi}{1}
                        \PY{n}{av\PYZus{}cust} \PY{o}{=} \PY{n}{av\PYZus{}cust} \PY{o}{+} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
        
        
                \PY{n}{av\PYZus{}cust} \PY{o}{=} \PY{n}{av\PYZus{}cust}\PY{o}{/}\PY{n}{total\PYZus{}row\PYZus{}cus}
                \PY{n}{av\PYZus{}subs} \PY{o}{=} \PY{n}{av\PYZus{}subs}\PY{o}{/}\PY{n}{total\PYZus{}row\PYZus{}sub}
                \PY{n}{ret\PYZus{}pair}\PY{o}{=}\PY{p}{\PYZob{}}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{average: Subscribers trip duration}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{av\PYZus{}subs}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{average: Customers trip duration}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{av\PYZus{}cust}\PY{p}{\PYZcb{}}
                \PY{k}{return} \PY{n}{ret\PYZus{}pair}
        
        \PY{n}{trip\PYZus{}record} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
        \PY{n}{type\PYZus{}trip\PYZus{}record} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
        \PY{n}{data\PYZus{}files1} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
        
        \PY{k}{for} \PY{n}{data\PYZus{}file} \PY{o+ow}{in} \PY{n}{data\PYZus{}files1}\PY{p}{:}
            \PY{n}{city} \PY{o}{=} \PY{n}{data\PYZus{}file}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}
           \PY{c+c1}{\PYZsh{} trip\PYZus{}record[city] = duration\PYZus{}of\PYZus{}trip(data\PYZus{}file)}
            \PY{n}{type\PYZus{}trip\PYZus{}record}\PY{p}{[}\PY{n}{city}\PY{p}{]} \PY{o}{=} \PY{n}{type\PYZus{}duration\PYZus{}of\PYZus{}trip}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}
        
        
        \PY{n+nb}{print}\PY{p}{(}\PY{n}{type\PYZus{}trip\PYZus{}record}\PY{p}{)}
\end{Verbatim}
...
library and to generate an example plot.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} load library}
...
and Customers for now: just collect all of the trip times and plot them.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to collect all of the trip times as a list \PYZsh{}\PYZsh{}}
        ...
        \PY{k}{def} \PY{n+nf}{trip\PYZus{}time}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
            \PY{n}{trip\PYZus{}time\PYZus{}data}\PY{o}{=}\PY{p}{[}\PY{p}{]}
            \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                    \PY{n}{trip\PYZus{}time\PYZus{}data}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
        
            \PY{k}{return} \PY{n}{trip\PYZus{}time\PYZus{}data}
        
        
        
        \PY{n}{record\PYZus{}trip} \PY{o}{=}\PY{p}{[}\PY{p}{]}
        \PY{k}{for} \PY{n}{data\PYZus{}file} \PY{o+ow}{in} \PY{n}{data\PYZus{}files1}\PY{p}{:}
            \PY{n}{record\PYZus{}trip} \PY{o}{=} \PY{n}{record\PYZus{}trip} \PY{o}{+} \PY{n}{trip\PYZus{}time}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}
            
        \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{record\PYZus{}trip}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of Trip Durations\PYZhy{}NYC\PYZhy{}2016\PYZhy{}Summary}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration in Minutes}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\textbf{Answer}: - Distribution of Trip
Durations(Subscribers)-NYC-2016-Summary: 1. Peak of Distribution --
{[}20,25{]} 2. Shape -- Normally Distributed - Distribution of Trip
Durations(Customers)-NYC-2016-Summary: 1. Peak of Distribution --
{[}5,10{]} 2. Shape -- positively skewed

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 5. \PYZsh{}\PYZsh{}}
        \PY{k}{def} \PY{n+nf}{type\PYZus{}trip\PYZus{}time}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
            \PY{n}{trip\PYZus{}time\PYZus{}data}\PY{o}{=}\PY{p}{[}\PY{p}{]}
            \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                \PY{n}{subs}\PY{o}{=}\PY{p}{[}\PY{p}{]}
                \PY{n}{cust}\PY{o}{=}\PY{p}{[}\PY{p}{]}
                \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                    \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                        \PY{n}{subs}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
                    \PY{k}{else}\PY{p}{:}
                        \PY{n}{cust}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
                        
            \PY{k}{return} \PY{p}{(}\PY{n}{subs}\PY{p}{,}\PY{n}{cust}\PY{p}{)}
        
        \PY{n}{subs\PYZus{}data}\PY{p}{,}\PY{n}{cust\PYZus{}data}\PY{o}{=}\PY{n}{type\PYZus{}trip\PYZus{}time}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}
        \PY{n}{bar\PYZus{}range} \PY{o}{=} \PY{l+m+mi}{75}
        \PY{n}{bar\PYZus{}width} \PY{o}{=} \PY{l+m+mi}{5}
        \PY{n}{number\PYZus{}of\PYZus{}bins}\PY{o}{=}\PY{n}{bar\PYZus{}range}\PY{o}{/}\PY{o}{/}\PY{n}{bar\PYZus{}width}
        \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{subs\PYZus{}data}\PY{p}{,}\PY{n+nb}{range}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{75}\PY{p}{)}\PY{p}{,}\PY{n}{bins}\PY{o}{=}\PY{n}{number\PYZus{}of\PYZus{}bins}\PY{p}{,}\PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{red}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of Trip Durations(Subscribers)\PYZhy{}NYC\PYZhy{}2016\PYZhy{}Summary}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration in Minutes}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Frequency}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{cust\PYZus{}data}\PY{p}{,}\PY{n+nb}{range}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{75}\PY{p}{)}\PY{p}{,}\PY{n}{bins}\PY{o}{=}\PY{n}{number\PYZus{}of\PYZus{}bins}\PY{p}{,}\PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{green}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of Trip Durations(Customers)\PYZhy{}NYC\PYZhy{}2016\PYZhy{}Summary}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration in Minutes}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Frequency}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
\textbf{Question 6}: How does ridership differ by month or season? Which
month / season has the highest ridership? Does the ratio of Subscriber
trips to Customer trips change depending on the month or season?. Your
investigation should involve at least two variables and should compare
at least two groups. You should also use at least one visualization as
part of your explorations.

\textbf{Answer}: The Month has the highest ridership(combine
Customer,Subscriber): September. - So Yes,The ratio of Subscriber trips
to Customer trips change depending on the month
...
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to continue to explore the dataset. \PYZsh{}\PYZsh{}}
        ...
        \PY{k}{def} \PY{n+nf}{monthwise\PYZus{}ridership}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
            \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                \PY{n}{counter\PYZus{}monthly\PYZus{}ride\PYZus{}cust} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{0} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{13}\PY{p}{)}\PY{p}{]}
        
                \PY{n}{counter\PYZus{}monthly\PYZus{}ride\PYZus{}subs} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{0} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{13}\PY{p}{)}\PY{p}{]}
        
                \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                    \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Customer}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}
                        \PY{n}{counter\PYZus{}monthly\PYZus{}ride\PYZus{}cust}\PY{p}{[}\PY{n+nb}{int}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{]} \PY{o}{=} \PY{n}{counter\PYZus{}monthly\PYZus{}ride\PYZus{}cust}\PY{p}{[}\PY{n+nb}{int}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{]} \PY{o}{+} \PY{l+m+mi}{1}
                    \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Subscriber}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}
                        \PY{n}{counter\PYZus{}monthly\PYZus{}ride\PYZus{}subs}\PY{p}{[}\PY{n+nb}{int}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{]} \PY{o}{=} \PY{n}{counter\PYZus{}monthly\PYZus{}ride\PYZus{}subs}\PY{p}{[}\PY{n+nb}{int}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{]} \PY{o}{+} \PY{l+m+mi}{1}
        
                \PY{k}{return} \PY{n}{counter\PYZus{}monthly\PYZus{}ride\PYZus{}subs}\PY{p}{,} \PY{n}{counter\PYZus{}monthly\PYZus{}ride\PYZus{}cust}
        
        
        \PY{c+c1}{\PYZsh{} calling function}
        \PY{n}{data\PYZus{}files2} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
        \PY{n}{a}\PY{p}{,} \PY{n}{b} \PY{o}{=} \PY{n}{monthwise\PYZus{}ridership}\PY{p}{(}\PY{n}{data\PYZus{}files2}\PY{p}{)}
        
        \PY{n}{c} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{0} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{13}\PY{p}{)}\PY{p}{]}
        \PY{n}{d} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{0} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{13}\PY{p}{)}\PY{p}{]}
        
        \PY{k}{for} \PY{n}{ii} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{13}\PY{p}{)}\PY{p}{:}
            \PY{n}{c}\PY{p}{[}\PY{n}{ii}\PY{p}{]} \PY{o}{=} \PY{n}{a}\PY{p}{[}\PY{n}{ii}\PY{p}{]} \PY{o}{/} \PY{n}{b}\PY{p}{[}\PY{n}{ii}\PY{p}{]}  \PY{c+c1}{\PYZsh{} for proportion}
            \PY{n}{d}\PY{p}{[}\PY{n}{ii}\PY{p}{]} \PY{o}{=} \PY{n}{a}\PY{p}{[}\PY{n}{ii}\PY{p}{]} \PY{o}{+} \PY{n}{b}\PY{p}{[}\PY{n}{ii}\PY{p}{]}  \PY{c+c1}{\PYZsh{} for combine ridership}
        
        \PY{n}{high\PYZus{}month\PYZus{}subs} \PY{o}{=} \PY{n}{calendar}\PY{o}{.}\PY{n}{month\PYZus{}name}\PY{p}{[}\PY{n}{a}\PY{o}{.}\PY{n}{index}\PY{p}{(}\PY{n+nb}{max}\PY{p}{(}\PY{n}{a}\PY{p}{)}\PY{p}{)}\PY{p}{]}
        \PY{n}{high\PYZus{}month\PYZus{}cust} \PY{o}{=} \PY{n}{calendar}\PY{o}{.}\PY{n}{month\PYZus{}name}\PY{p}{[}\PY{n}{b}\PY{o}{.}\PY{n}{index}\PY{p}{(}\PY{n+nb}{max}\PY{p}{(}\PY{n}{b}\PY{p}{)}\PY{p}{)}\PY{p}{]}
        \PY{n}{high\PYZus{}month\PYZus{}both} \PY{o}{=} \PY{n}{calendar}\PY{o}{.}\PY{n}{month\PYZus{}name}\PY{p}{[}\PY{n}{d}\PY{o}{.}\PY{n}{index}\PY{p}{(}\PY{n+nb}{max}\PY{p}{(}\PY{n}{d}\PY{p}{)}\PY{p}{)}\PY{p}{]}
        
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Ridership Differ by Month(combine Customer,Subscriber):}\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{d}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{:}\PY{p}{]}\PY{p}{)}\PY{p}{)}
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Month has the Highest Ridership(combine Customer,Subscriber): }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{high\PYZus{}month\PYZus{}both}\PY{p}{)}\PY{p}{)}
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Month has the Highest Ridership(Subscriber): }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{high\PYZus{}month\PYZus{}subs}\PY{p}{)}\PY{p}{)}
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Month has the Highest Ridership(Customer) : }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{high\PYZus{}month\PYZus{}cust}\PY{p}{)}\PY{p}{)}
        \PY{c+c1}{\PYZsh{} ratio of Subscriber trips to Customer trips change depending on the month}
        
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Ratio of Subscriber trips to Customer trips change depending on the month:}\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{c}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{:}\PY{p}{]}\PY{p}{)}\PY{p}{)}
        
        \PY{n}{height} \PY{o}{=} \PY{n}{c}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{:}\PY{p}{]}
        
        \PY{n}{month\PYZus{}name} \PY{o}{=}\PY{p}{[}\PY{p}{]}
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{13}\PY{p}{)}\PY{p}{:}
            \PY{n}{month\PYZus{}name}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{calendar}\PY{o}{.}\PY{n}{month\PYZus{}name}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{)}
        \PY{n}{bars} \PY{o}{=} \PY{n}{month\PYZus{}name}
        \PY{n}{y\PYZus{}pos} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{bars}\PY{p}{)}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{} Create horizontal bars}
        \PY{n}{plt}\PY{o}{.}\PY{n}{barh}\PY{p}{(}\PY{n}{y\PYZus{}pos}\PY{p}{,} \PY{n}{height}\PY{p}{,}\PY{n}{color} \PY{o}{=} \PY{p}{(}\PY{l+m+mf}{0.5}\PY{p}{,}\PY{l+m+mf}{0.1}\PY{p}{,}\PY{l+m+mf}{0.5}\PY{p}{,}\PY{l+m+mf}{0.6}\PY{p}{)}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{} Create names on the y\PYZhy{}axis}
        \PY{n}{plt}\PY{o}{.}\PY{n}{yticks}\PY{p}{(}\PY{n}{y\PYZus{}pos}\PY{p}{,} \PY{n}{bars}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Ratio of Subscriber Trips to Customer Trips Depending on the Month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Ratio of Subscriber trips to Customer trips}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: I will like apply data science techinique into medical
industry.How certain medicine affect the patients based on their
condition.So side affect and effectiveness can be predicted based on
certain patients condition prior.So data science can be life saving and
healthcare improving. \textgreater{} \textbf{Tip}: If we want to share
the results of our analysis with others, we aren't limited to giving
them a copy of the jupyter Notebook (.ipynb) file. We can also export
the Notebook output in a form that can be opened even for those without
Python installed. From the \textbf{File} menu in the upper left, go to
